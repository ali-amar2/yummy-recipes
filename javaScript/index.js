    ...
    container.append(`
      ...
      data.categories[i].strCategoryDescription
                    ...
                    <div class="layer position-absolute w-100 h-100 d-flex align-items-center flex-column text-black">
                        <h2 class="text-black ps-2">${
                          data.categories[i].strCategory
                        }</h2>
                        <p class="text-center">${data.categories[
                          i
    ...
    container.append(`
        <div class="col-12 col-md-3">
            <div class="card bg-black mb-4 border-0 position-relative overflow-hidden d-flex justify-content-center align-items-center rounded-3">
                ...
                <h4 class="text-white text-center mb-3 fs-3">${
                  data.meals[i].strIngredient
                }</h4>
                <p class="text-center text-white m-0">${data.meals[
                  i
                ].strDescription
                  .split(" ")
                  .slice(0, 16)
...
async function displayContact() {
  container.append(`
    ...
    <div class="row py-4 d-flex align-items-center align-content-center min-vh-100">
        ...
        <div class="col-12 col-md-6">
            ...
            <p class="emailWarning warn d-none">Email not valid *example@yyy.zzz</p>
        </div>
        <div class="col-12 col-md-6">
        ...
        <div class="col-12 col-md-6">
            ...
            <p class="repassWarning warn d-none">Passwords do not match</p>
        </div>
        <button type="button" class="submitBtn btn btn-danger m-auto p-3 mt-3 disabled">Submit</button>
    </div>
</form>`);
  ...
  function validatePasswords(showWarnings = true) {
    let valid = true;
    if (!passwordRegex.test(passwordInput.val())) {
      if (showWarnings) $(".passWarning").removeClass("d-none");
      valid = false;
    } else {
    ...
    if (
      ...
      if (showWarnings) $(".repassWarning").removeClass("d-none");
      valid = false;
    } else {
